...
Hours to complete assignment: 2ish
 ...
 **********************************************************************/
I compiled a binary using the GStest.cpp as a driver. The user can do this
by compiling with "make test" though the default make will also build the "test"
executable.
